...
class CommandLine {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            System.out.println ("SRKDBG: server port is: " + Integer.toString(port));
            File stopFile;
            stopFile = new File("/home/sulekha/Error-Ranking/chord-fork/pjbench/ftp/stop");
            while (true) {
                if (stopFile.exists()) {
                    System.out.println("SRKDBG: STOPPING.");
                    stopFile.delete(); 
                    break;
                }
            }
